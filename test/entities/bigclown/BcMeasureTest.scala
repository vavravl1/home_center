  ...
  "BcMeasure" when {
    "created" should {
      ...
      "should be serializable to json" in {
        Json.toJson(measure)(BcMeasure.writes).toString() shouldBe """{"location":"remote/1","sensor":"thermometer","phenomenon":"temperature","measureTimestamp":"1970-01-01T00:00:10Z","value":19,"unit":"C"}"""
      }
    }
  }
}
